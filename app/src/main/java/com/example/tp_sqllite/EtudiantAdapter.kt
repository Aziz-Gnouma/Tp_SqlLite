...
class EtudiantAdapter(private val etudiants: List<EtudiantBC>) : RecyclerView.Adapter<EtudiantAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val textViewGendre: TextView = itemView.findViewById(R.id.textViewGendre)
        ...
        fun bind(etudiant: EtudiantBC) {
            ...
            textViewGendre.text = "Gendre : ${etudiant.gender} "



            val textColorResId = if (etudiant.gender.equals("male", ignoreCase = true)) {
                R.color.blue // Replace with your actual color resource for male
            } else {
                R.color.pink
            }
            textViewGendre.setTextColor(ContextCompat.getColor(itemView.context, textColorResId))
